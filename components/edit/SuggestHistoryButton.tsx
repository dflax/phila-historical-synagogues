...
import SuggestHistoryForm from './SuggestHistoryForm'
...
export default function SuggestHistoryButton({ synagogueId, synagogueName }: Props) {
        ...
        >
          ...
          >
            ...
            <div className="flex items-start justify-between px-6 pt-6 pb-4 border-b border-gray-100 dark:border-gray-700">
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">Add a History Entry</h2>
              ...
              {submitted ? (
                <div className="text-center py-6 space-y-3">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Your history proposal is pending review. Editors will evaluate and apply approved additions.
                  </p>
