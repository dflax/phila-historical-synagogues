    ...
    <>
      ...
      {formOpen && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Add a new rabbi profile"
        >
          <div
          ...
          >
            ...
            <div className="flex items-start justify-between px-6 pt-6 pb-4 border-b border-gray-100 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-800 z-10">
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">Add a Rabbi</h2>
              ...
              {submitted ? (
                ...
                <div className="text-center py-6 space-y-3">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Your proposal is pending review. Once approved by an editor, the rabbi will appear in the directory.
                  </p>
