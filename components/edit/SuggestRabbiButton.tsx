...
import SuggestRabbiForm from './SuggestRabbiForm'
...
export default function SuggestRabbiButton({ synagogueId, synagogueName }: Props) {
        ...
        >
          ...
          >
            ...
            <div className="flex items-start justify-between px-6 pt-6 pb-4 border-b border-gray-100 dark:border-gray-700">
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">Add a New Leader</h2>
