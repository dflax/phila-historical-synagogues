    ...
    return (
      <>
        <button
          ...
          className={mobile
            ? 'w-full mt-2 px-4 py-3 rounded-lg text-left text-sm font-medium text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition'
            : 'bg-blue-600 hover:bg-blue-700 text-white px-4 py-1.5 rounded-lg text-sm font-medium transition shadow-sm'
          }
        >
          Sign in
        </button>
      ...
      <>
        ...
        <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">
          ...
          {role && ['editor', 'admin', 'super_admin'].includes(role) && (
            <Link
              href="/admin"
              className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm text-purple-700 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition"
            >
          ...
          {role && ['contributor', 'editor', 'admin', 'super_admin'].includes(role) && (
            <button
              onClick={() => setExportOpen(true)}
              className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm text-purple-700 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition"
            >
              <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          ...
          <Link
            href="/contributions"
            className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition"
          >
            <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition"
          >
            <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
